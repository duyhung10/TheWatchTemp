(function(){
    ...
    RoleDetailController.$inject = ['$rootScope','$scope','$state','$stateParams','Role', 'Privilege', 'AlertService','$translate','variables', '$timeout', 'TranslateCommonUI','ErrorHandle'];
    function RoleDetailController($rootScope,$scope, $state, $stateParams, Role, Privilege, AlertService,$translate, variables, $timeout, TranslateCommonUI, ErrorHandle) {
        var vm = this;
        ...
        $scope.pageTitle2 = "admin.role.detail";
            ...
            if (angular.element('#tFilter').length) {
                Privilege.getAll().then(function (data) {
                    ...
                    Role.getOne($stateParams.roleName).then(function (data) {
                        ...
                        $scope.role.createdDate = getDateString($scope.role.created);
                        $scope.role.updatedDate = getDateString($scope.role.updated);
